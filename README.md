...
Pulumi Kubernetes stack for a minimal Minecraft server deployment.
...
PULUMI_STACK=dev bun run up
```

### Preview / Destroy

```bash
PULUMI_STACK=dev bun run preview
PULUMI_STACK=dev bun run destroy
```
